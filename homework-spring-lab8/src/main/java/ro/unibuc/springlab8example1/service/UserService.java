...
public class UserService {
    ...
    public List<UserDto> getUsersFilteredByType(String type) {
        List<User> usersFiltered = userRepository.getUsersFilteredByType(type);
        return usersFiltered.stream().map(p -> userMapper.mapToDto(p)).collect(Collectors.toList());
    }
}
